...
\begin{theorem}(О касательном пространстве к гладкому пути)
    ...
    Пусть $M$ --- гладкое многообразие. Тогда $\v \in T_\elp(M) \Llra \exists
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item[$\Lra$] Пусть имеется вектор $\v \in T_\elp(M)$, построим путь,
...
\end{align*}
        ...
        вектор $\v$ лежит в $T_\elp(M)$. Для этого воспользуемся подготовленным
